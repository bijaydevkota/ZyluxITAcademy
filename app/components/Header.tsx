...
const Header = () => {
  return (
    ...
    >
       <a href="#course" className=' p-1 flex justify-center text-white bg-[#33c6f2] cursor-pointer'>Enroll now for extra 20% off</a>
      ...
      <nav className="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <ul className="flex space-x-4">
            <motion.li  className="flex gap-4 items-center">
              ...
              <a href="/contact" className="hover:text-[#33c6f2] transition-colors">Contact</a>
